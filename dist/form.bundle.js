...
form.addEventListener('submit', async event => {
  ...
  /* eslint-disable */
  console.log(...oo_oo(`524981082_18_4_18_24_4`, article));
  if (formIsValid(article)) {
    ...
    /* eslint-disable */
    console.log(...oo_oo(`524981082_34_8_34_25_4`, body));
