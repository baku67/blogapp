...
/* harmony import */ var _assets_js_modal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../assets/js/modal */ "./src/assets/js/modal.js");
...
const initForm = async () => {
  ...
  /* eslint-disable */
  console.log(...oo_oo(`3905464733_22_4_22_23_4`, params));
  ...
  if (idArticle) {
    ...
    fillForm(article);
    /* eslint-disable */
    console.log(...oo_oo(`3905464733_30_8_30_28_4`, article));
  }
};
initForm();
const fillForm = article => {
  ...
  /* eslint-disable */
  console.log(...oo_oo(`3905464733_38_4_38_27_4`, formFields));
  formFields.forEach(field => {
    field.value = article[field.name];
  });
};
cancelButton.addEventListener('click', async () => {
  const answer = await (0,_assets_js_modal__WEBPACK_IMPORTED_MODULE_2__.openModal)("Voulez-vous vraiment annuler ?");
  if (answer) {
    location.assign('/');
  }
});
...
form.addEventListener('submit', async event => {
  ...
  /* eslint-disable */
  console.log(...oo_oo(`3905464733_65_4_65_24_4`, article));
  if (formIsValid(article)) {
    ...
    /* eslint-disable */
    console.log(...oo_oo(`3905464733_91_8_91_25_4`, body));
